...
<form action="{{route('db.c.post_article.update',['id'=>$post->id])}}" method="post"  enctype='multipart/form-data' >
	@csrf
	@method('PUT')
				...
				<div class="card-header">
					<h3 class="title">Upload Futured Image</h3>
				 	...
				 	<div class="card-body">
				 		<div class="row">
				 			<div class="col-md-12">
				 				<img id="thumb" src="{{isset($post->featured_images)?asset($post->featured_images):''}}" style="margin-top:15px;height: auto; width:200px;">
				 			</div>
				 		</div>
				 	</div>
