    ...
    <div class="card-body" style="background-image: url('https://i.pinimg.com/originals/6d/9f/a9/6d9fa9355eccc27478bf914c97dd7cec.jpg');">
        <div class="row"> 
            <div class="col-md-12  margin-b-15 text-center">
			    <img src="{{url(Auth::user()->avatar)}}" class=" img-circle col-4 col-sm-6 col-md-2" id="cover-photo-user-trigger-change" style=" background: #fff; float:unset;" onclick="$('#avatar-source').click();" data-toggle="tooltip" data-placement="right" title="" data-original-title="Change">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="btn" class="btn btn-warning" onclick="uploadava()">Update</button>
